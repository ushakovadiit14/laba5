...
Демонстрационный класс (FileReaderDemo): Показывает работу системы, Загружает данные из файла, Показывает всех абитуриентов и их статус, Выводит список допущенных
